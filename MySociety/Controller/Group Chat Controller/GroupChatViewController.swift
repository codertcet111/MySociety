...
class GroupChatViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    @IBOutlet weak var gropuChatTextFieldHeightCOnstraints: NSLayoutConstraint!
...
//        self.typeMessageTextField.addTarget(self, action: #selector(self.textFieldDidChange(_:)),
//        for: .editingChanged)
        getChatData(true)
    }
    
    
    @IBAction func editingDidBeging(_ sender: UITextField) {
        self.gropuChatTextFieldHeightCOnstraints.constant = 350.0
        self.view.layoutIfNeeded()
    }
    
    
    @IBAction func editingDidBeginTextField(_ sender: UITextField) {
        print("****")
        self.gropuChatTextFieldHeightCOnstraints.constant = 350.0
        self.view.layoutIfNeeded()
    }
...
//    }
    ...
    @IBAction func textField(_ sender: AnyObject) {
        ...
        self.gropuChatTextFieldHeightCOnstraints.constant = 90.0
        self.view.layoutIfNeeded()
